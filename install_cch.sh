...
sudo curl -o $INSTALL_DIR/cch "$SCRIPT_URL"/cch
sudo curl -o $INSTALL_DIR/commands.txt "$SCRIPT_URL"/commands.txt
sudo curl -o $INSTALL_DIR/script_template "$SCRIPT_URL"/script_template

# Make the script executable
sudo chmod +x $INSTALL_DIR/$SCRIPT_NAME
# make commands.txt readable and writable.
sudo chmod o+rw "$INSTALL_DIR"/commands.txt
